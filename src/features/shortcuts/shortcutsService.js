...
class ShortcutsService {
    ...
    async toggleAllWindowsVisibility() {
        ...
        console.log(`[Shortcuts] Toggle visibility: current=${this.allWindowVisibility}, target=${targetVisibility}`);
        ...
        // Register appropriate shortcuts based on new state
        if (this.allWindowVisibility) {
            // App is now visible - register all shortcuts
            await this.registerShortcuts();
        } else {
            // App is now hidden - register only toggle visibility shortcut
