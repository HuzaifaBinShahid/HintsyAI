...
const SidebarComponent = ({ isCollapsed, onToggle, onSearchClick }: SidebarProps) => {
    ...
    const navigation = useMemo<NavigationItem[]>(
        () => [
            ...
            },
            {
                ...
                icon: '/dashboard.svg',
                isLucide: false,
                ariaLabel: 'View usage dashboard',
            },
            {
                name: 'My Activity',
                href: '/activity',
    ...
    const settingsSubmenu = useMemo<SubmenuItem[]>(
        () => [
            ...
            { name: 'Usage Dashboard', href: '/dashboard', icon: '/dashboard.svg', isLucide: false, ariaLabel: 'View usage dashboard' },
    ...
    const bottomItems = useMemo(
        () => [
            ...
            // },
            {
                href: 'https://firebasestorage.googleapis.com/v0/b/hintsy.firebasestorage.app/o/hintsy%2FHintsyAI-0.2.4-universal.dmg?alt=media&token=371b31d6-929f-4915-821c-6a2db18349b8',
                icon: '/download.svg',
                text: 'Download HintsyAI',
                ariaLabel: 'Download HintsyAI (new window)',
            },
        ],
        []
    );
            ...
            <header className={`group relative h-6 flex shrink-0 items-center justify-between`}>
                {isCollapsed ? (
                    <div className="flex items-center">
                        <span className="mx-3 shrink-0 text-lg font-bold text-[#282828]">H</span>
                        <button
                    ...
                    <>
                        <div className="flex items-center">
                            <span className="mx-3 shrink-0 text-lg font-bold text-[#282828]">Hintsy AI</span>
                        </div>
                        <button
                            onClick={toggleSidebar}
                            onKeyDown={e => handleKeyDown(e, toggleSidebar)}
