...
`;
        ...
        try {
            ...
            const upgradeMessage = firestoreUsageService.getUpgradeMessage();
                console.log('[SummaryService] Usage limit reached:', upgradeMessage);
                throw new Error(`Usage limit reached: ${upgradeMessage.message}`);
            }
...
Keep all points concise and build upon previous analysis if provided.`,
            ...
            console.log('[SummaryService] Usage recorded for successful analysis request');
