...
contextBridge.exposeInMainWorld('api', {
  ...
  common: {
    ...
    // App Control
      ...
      showUsageLimitModal: (modalData) => ipcRenderer.invoke('show-usage-limit-modal', modalData),
      hideUsageLimitModal: () => ipcRenderer.invoke('hide-usage-limit-modal'),
  ...
  // Generic invoke method for dynamic channel names
  ...
  mainHeader: {
    ...
    // Meeting Detection
    startMeetingMonitoring: () => ipcRenderer.invoke('mainHeader:start-meeting-monitoring'),
    stopMeetingMonitoring: () => ipcRenderer.invoke('mainHeader:stop-meeting-monitoring'),
    getMeetingInfo: () => ipcRenderer.invoke('mainHeader:get-meeting-info'),
    isInMeeting: () => ipcRenderer.invoke('mainHeader:is-in-meeting'),
    autoShow: () => ipcRenderer.invoke('mainHeader:auto-show'),
    ensureVisible: () => ipcRenderer.invoke('mainHeader:ensure-visible'),
    
    // Meeting Detection Listeners
    onMeetingDetected: (callback) => ipcRenderer.on('meeting:detected', callback),
    removeOnMeetingDetected: (callback) => ipcRenderer.removeListener('meeting:detected', callback)
  },
